...
(function (global) {
  ...
  const EDUCATION_PATHS = {
    NONE: {
      ...
      description: { en: "No formal education", ru: "Без образования" }
    },
    COMMUNITY_COLLEGE: {
      id: "community",
      level: 1.5,
      ...
      description: { en: "Associate's degree. Mid-tier jobs.", ru: "Среднее. Обычные работы." }
    },
    TRADE_SCHOOL: {
      id: "trade",
      level: 2,
      ...
      description: { en: "Trade certification. Stable blue-collar careers.", ru: "Рабочая специальность." }
    },
    BOOTCAMP: {
      id: "bootcamp",
      level: 2,
      ...
      description: { en: "Tech skills fast track. Developer jobs.", ru: "Быстрый путь в IT." }
    },
    UNIVERSITY: {
      id: "university",
      level: 3,
      ...
      description: { en: "Bachelor's degree. Wide career options.", ru: "Высшее. Широкие возможности." }
    },
    MASTERS: {
      id: "masters",
      level: 4,
      ...
      description: { en: "Advanced degree. Management track.", ru: "Магистратура." }
    },
    PHD: {
      id: "phd",
      level: 5,
      ...
      description: { en: "Doctorate. Research & academia.", ru: "Докторская степень." }
    }
  };
  ...
  const JOB_FAMILIES = {
    SERVICE: {
      ...
      example: { en: "Retail, Restaurant, Customer Service", ru: "Продажи, Рестораны" }
    },
    BLUE_COLLAR: {
      id: "blue_collar",
      ...
      requiresSkill: "trade",
      example: { en: "Electrician, Plumber, Mechanic", ru: "Электрик, Сантехник" }
    },
    TECH: {
      id: "tech",
      ...
      example: { en: "Developer, Designer, Data Analyst", ru: "Разработчик, Дизайнер" }
    },
    WHITE_COLLAR: {
      id: "white_collar",
      ...
      example: { en: "Accountant, Lawyer, Consultant", ru: "Бухгалтер, Юрист" }
    },
    CREATIVE: {
      id: "creative",
      ...
      example: { en: "Writer, Artist, Musician", ru: "Писатель, Художник" }
    },
    MEDICAL: {
      id: "medical",
      ...
      example: { en: "Doctor, Nurse, Surgeon", ru: "Врач, Медсестра" }
    }
  };
  ...
  function patchI18n() {
    ...
    Object.assign(ru, {
      ...
      "edu.certification": "Профессиональный сертификат",
      "edu.enroll": "Поступить",
      "edu.graduate": "Выпуститься",
      "edu.dropout": "Бросить учёбу",
      "edu.gpa": "Средний балл",
      "edu.years_remaining": "Осталось {years} лет",
      "edu.scholarship": "Стипендия получена!",
      "edu.exam_passed": "Экзамен сдан!",
      "edu.exam_failed": "Экзамен провален",
      ...
      "invest.type.startups": "Инвестиции в стартапы",
      ...
      "invest.buy": "Инвестировать",
      "invest.sell": "Продать",
      "invest.risk.low": "Низкий риск",
      "invest.risk.moderate": "Умеренный риск",
      "invest.risk.high": "Высокий риск",
      "invest.risk.very_high": "Очень высокий риск",
